...
def setup_CDV():
    ...
    sql_db = shared.sqlite_create_connection("cim900.db")
    shared.sqlite_create_table(
        sql_db,
...
if __name__ == "__main__":
    ...
    pprint.pprint(
        shared.sqlite_select_data(sql_db, "SELECT * FROM view_branch_details limit 2;")
    )

    print("Weighting factors:")
    pprint.pprint(
        shared.sqlite_select_data(
            sql_db, "SELECT * FROM view_weighting_factor limit 2;"
        )
    )
